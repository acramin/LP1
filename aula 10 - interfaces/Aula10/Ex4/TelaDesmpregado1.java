...
public class TelaDesmpregado1 extends JFrame implements ActionListener {

    Container tela;
    JButton bVoltar, bCalcula, bLimpar;
    JTextField cNome, cDesemp, cCPF;
    JLabel lNome, lDesemp, lCPF;

    public TelaDesmpregado1() {
        super("Desempregado");
        ...
        cDesemp = new JTextField("", 30);
        lNome = new JLabel("Nome completo: ");
        lCPF = new JLabel("Cpf: ");
        lDesemp = new JLabel("Seguro desemprego: ");
        ...
        cDesemp.addKeyListener(new KeyListener() {
            public void keyTyped(KeyEvent e) {
                char c = e.getKeyChar();
        ...
        gbc.gridx = 0;
        gbc.gridy = 2;
        info.add(lDesemp, gbc);

        gbc.gridx = 1;
        gbc.gridy = 2;
        info.add(cDesemp, gbc);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == bCalcula) {
            ...
            double s = Double.parseDouble(cDesemp.getText());
            Desempregado1 m = new Desempregado1(n, "", f, s);
            JOptionPane.showMessageDialog(null, "Dados \nNome:" + m.getNome() + "\nCPF: "
                    + m.getCpf() + "\nSeguro Desemprego: " + m.getSeguroDesemprego());
        }
    }
}

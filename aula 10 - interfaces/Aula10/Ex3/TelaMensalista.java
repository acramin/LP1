...
public class TelaMensalista extends JFrame implements ActionListener {

    Container tela;
    JButton bVoltar, bCalcula, bLimpar;
    JTextField cNome, cSalario, cCPF;
    JLabel lNome, lSalario, lCPF;

    public TelaMensalista() {
        super("Mensalista");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == bCalcula) {
            ...
            Mensalista m = new Mensalista(cNome.getText(), s);

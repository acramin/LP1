...
{
	private JTextField txtCoordenadaX, txtCoordenadaY, txtRaio, txtAltura, txtArea, txtPerimetro, txtVolume, txtSuperficie;
	private JLabel lblCoordenadaX, lblCoordenadaY, lblRaio, lblAltura, lblArea, lblPerimetro, lblVolume, lblSuperficie;
   ...
   public void actionPerformed(ActionEvent e)
   {
		...
		if(e.getSource() == btnCalcula) 
      {
			...
			if(coordenadaX.length() > 0 && coordenadaY.length() > 0 && raio.length() > 0 && altura.length() > 0) 
         {
				// e um cilindro
            ...
            // estou usando o this em vez de null para travar a tela de
				...
				JOptionPane.showMessageDialog(this, cilindro, "Formas", JOptionPane.INFORMATION_MESSAGE);
			} 
         else if(coordenadaX.length() > 0 && coordenadaY.length() > 0 && raio.length() > 0) 
         {
				// e um circulo
            ...
            // calcular
				...
				JOptionPane.showMessageDialog(this, circulo, "Formas", JOptionPane.INFORMATION_MESSAGE);
			}
         else if(coordenadaX.length() > 0 && coordenadaY.length() > 0) 
         {
				...
				txtVolume.setText("");
				txtSuperficie.setText("");
				JOptionPane.showMessageDialog(this, ponto, "Formas", JOptionPane.INFORMATION_MESSAGE);
			}
         else
         {
				JOptionPane.showMessageDialog(this, "Dados invalidos.", "Formas", JOptionPane.ERROR_MESSAGE);
			}
      }
